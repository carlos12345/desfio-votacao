...
import br.com.dbserver.assembleia.application.v1.usecase.implementations.ConsultaAssembleiaPorIdUseCaseImpl;
import br.com.dbserver.assembleia.application.v1.usecase.implementations.ConsultaTodasAssembleiasUseCaseImpl;
import br.com.dbserver.assembleia.application.v1.usecase.implementations.CriarAssembleiaUseCaseImpl;
import br.com.dbserver.assembleia.application.v1.usecase.implementations.EncerrarAssembleiaUseCaseImpl;
import br.com.dbserver.assembleia.infrastructure.presentation.path.Paths;
import br.com.dbserver.assembleia.infrastructure.presentation.v1.controller.port.AssembleiaControllerPort;
